...
($\Delta F_1 \leq 0{,}20$). Условия: препроцессор пересобран на
11 общих числовых признаках UNSW и CICIDS; CNN-LSTM обучена на
UNSW-train с сокращенным набором признаков; оценка на UNSW-test и
CICIDS-test (subsample 200\,000 строк CICIDS, random\_state\,=\,42).

Результаты: UNSW F1-max = 0,9485; CICIDS F1-max = 0,7945;
CICIDS F1 при использовании UNSW-калиброванного порога (zero-shot)
= 0,7679; $\Delta F_1 = 0{,}181$. Соответствие NFR-7 ---
выполнено.
